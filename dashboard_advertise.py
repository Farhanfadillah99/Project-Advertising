...
engine = create_engine('mysql+mysqlconnector://root:fadillahfarhan99@localhost/ad?host=localhost?port=3306')
conn = engine.connect()
            ...
            html.Div(children=[
                ...
                html.Div(children=[
                    html.Div(children=[
                       ...
                       html.P('Hour: ',className='ml-2 mr-2'),
                       dcc.Input(id='Hour',type='number',value='0',className='col-2 form-control',),
